...
1. [x] Kotlin no está incluido en los lenguajes donde GitHub Copilot ofrece un soporte sólido. Como resultado, las sugerencias de código podrían no tener la misma calidad que las sugerencias de código en un lenguaje con mejor soporte, como Ruby, Java o C#.
...
1. [ ] Kotlin no está incluido en los lenguajes donde GitHub Copilot ofrece un soporte sólido. Como resultado, GitHub Copilot aún puede explicar o corregir el código, pero no podrá proporcionar sugerencias de código.

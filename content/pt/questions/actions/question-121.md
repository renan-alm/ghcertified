...
- [x] Variáveis de ambiente padrão são definidas pelo GitHub e não em um workflow
- [x] A maioria das variáveis de ambiente padrão possui uma propriedade de contexto correspondente
